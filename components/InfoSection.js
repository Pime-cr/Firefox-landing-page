const InfoSection = () => {
    return ( 
        <section>
            <h1 className="md:text-6xl text-5xl text-center font-medium md:mt-40 md:mb-80 my-28">Pitchfork Kickstarter Taxidermy</h1>
            <div className="flex px-5 pb-24 items-center flex-col">
                <div className="relative w-full flex justify-center items-end">
                    <img src="image_info1.png" alt="image_info1" className="w-4/5 md:w-8/12 h-1/5 mb-10 object-cover object-center rounded z-20"/>
                ...
                <div className="xl:w-2/3 w-full px-8 xl:px-0 mt-5 md:mt-0 flex justify-between lg:flex-row flex-col gap-10">
                    <div>
                        ...
                        <p className="mb-8 leading-relaxed">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur illum nulla alias optio officiis unde, esse rerum voluptates, ab sunt quasi in nesciunt neque, asperiores itaque aspernatur a! Omnis, eaque!</p>
                    </div>
                    <div>
                        <h1 className="sm:text-4xl text-3xl mb-4 font-medium">Lorem ipsum dolor sit amet.</h1>
                        <p className="mb-8 leading-relaxed">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur illum nulla alias optio officiis unde, esse rerum voluptates, ab sunt quasi in nesciunt neque, asperiores itaque aspernatur a! Omnis, eaque!</p>
            ...
            <div className="container px-5 pb-24 mx-auto">
                <div className="flex flex-col md:flex-row flex-wrap -mx-4 -mb-10">
                    <div className="md:w-1/2 mb-10 px-4 flex flex-col items-center justify-center">
                        <div className="h-80 lg:h-96">
                            <img src="image_info2.png" alt="image_info2" className="object-cover object-center w-full h-full"></img>
                        </div>
                        <h2 className="text-4xl font-medium mt-6 mb-3">Lorem ipsum dolor sit.</h2>
                        <p className="leading-relaxed text-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis earum nulla, reiciendis magni vel voluptatibus? Voluptate mollitia exercitationem minus ipsa ex, optio sit accusantium, itaque asperiores, modi autem accusamus perspiciatis.</p>
                    </div>
                    <div className="md:w-1/2 mb-10 px-4 flex flex-col items-center justify-center">
                        <div className="h-80 lg:h-96">
                            <img src="image_info3.png" alt="image_info3" className="object-cover object-center w-full h-full"></img>
                        </div>
                        <h2 className="text-4xl font-medium mt-6 mb-3">Lorem ipsum dolor sit.</h2>
                        <p className="leading-relaxed text-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis earum nulla, reiciendis magni vel voluptatibus? Voluptate mollitia exercitationem minus ipsa ex, optio sit accusantium, itaque asperiores, modi autem accusamus perspiciatis.</p>
                    </div>
